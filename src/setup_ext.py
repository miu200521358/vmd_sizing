...
ext = [Extension("module.MMath", sources=["module/MMath.pyx"], include_dirs=['.', get_include()]), \
       ...
       Extension("mmd.VmdData", sources=["mmd/VmdData.pyx"], \
                 include_dirs=['.', 'C:/Development/Anaconda3/envs/vmdsizing_cython_exe1/Lib/site-packages/bezier/include', get_include()]), \
       Extension("service.parts.StanceService", sources=["service/parts/StanceService.pyx"], include_dirs=['.', get_include()]), \
       Extension("service.parts.ArmAvoidanceService", sources=["service/parts/ArmAvoidanceService.py"], include_dirs=['.', get_include()]), \
       ]
