...
ext = [Extension("module.MMath", sources=["module/MMath.pyx"], include_dirs=['.', bezier_path, get_include()], define_macros=[('CYTHON_TRACE', '1')]), \
       # Extension("module.MMath", sources=["module/MMath.pyx"], include_dirs=['.', bezier_path, get_include()]), \
