...
def main(motion, trace_model, replace_model, output_vmd_path, \
    is_avoidance, is_avoidance_finger, is_hand_ik, hand_distance, is_floor_hand, hand_floor_distance, leg_floor_distance, vmd_choice_values, rep_choice_values, rep_rate_values, \
    ...
    # 腕IK処理
    is_success = sub_arm_ik.exec(motion, trace_model, replace_model, output_vmd_path, is_avoidance, is_hand_ik, hand_distance, is_floor_hand, hand_floor_distance, leg_floor_distance, org_motion_frames) and is_success
