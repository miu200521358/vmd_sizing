...
・キーフレ間の補間方法は、三種類
　・補間曲線に従う　…　キーフレに登録されている補間曲線に従って補間します。キーの全打ちと同等
　・補間曲線を無視（円形）　…　補間曲線を無視して、三点を繋いだ球になる形で軌跡を作ります。スケートモーションとかにも使えるかもしれません。
　・補間曲線を無視（曲線）　…　補間曲線を無視して、キーフレをカトマル曲線で繋いだ軌跡を作ります。
...
　それでも解決出来ない場合、不具合報告フォームよりご報告ください。
