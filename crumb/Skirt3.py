...
def exec():
    ...
    for target_bone_name, target_material_name, start_vertex_idx, y_density, x_density, collision_group_idx, rigidbody_param_to, \
        min_vertical_limit_rot, max_vertical_limit_rot, min_horizonal_limit_rot, max_horizonal_limit_rot in \
            [("mt", "マント", 5837, 3, 1, 1, RigidBodyParam(0.1, 0.99, 0.99, 0, 0.5), 20, 20, 20, 40)]:
    # for target_bone_name, target_material_name, y_density, x_density, collision_group_idx, rigidbody_param_to, \
    #     min_vertical_limit_rot, max_vertical_limit_rot, min_horizonal_limit_rot, max_horizonal_limit_rot in \
    #         [("内sk", "内スカート", 3, 2, 1, RigidBodyParam(0.5, 0.9999, 0.9999, 0, 0.5), 10, 20, 40, 60), \
    #          ("外sk", "外スカート", 4, 3, 2, RigidBodyParam(0.3, 0.99, 0.99, 0, 0.5), 10, 20, 60, 80)]:
    # for target_bone_name, target_material_name, y_density, x_density, collision_group_idx, rigidbody_param_to, \
    #     min_vertical_limit_rot, max_vertical_limit_rot, min_horizonal_limit_rot, max_horizonal_limit_rot in \
    #         [("sk", "スカート", 3, 2, 1, RigidBodyParam(0.5, 0.9999, 0.9999, 0, 0.5), 10, 20, 40, 60)]:
        ...
        root_bone = Bone(bone_name, bone_name, model.bones["首"].position, model.bones["首"].index, 0, 0x0000 | 0x0002 | 0x0008 | 0x0010)
